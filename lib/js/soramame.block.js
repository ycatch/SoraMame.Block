 ...
 */
	...
	(function() {
		...
		*/
		...
		$('.serialize').find('span.exp-body').click(function() {
		...
		/** When open daialog, focus on textbox for bootstrap3 */
		...
		soramame.clodeExpDialog = function() {
			...
			soramame.expDialog_hundle.next().find('span.code-exp').text(strTextBox);
